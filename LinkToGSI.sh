...
ROM_INPUT=$1
ROM_TYPE=$2
partitions="vendor system system_ext product mi_ext odm optics prism mi_ext my_bigball my_engineering my_manifest my_region my_carrier my_heytap my_product my_stock"
